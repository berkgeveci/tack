...
class KernelTransformer(ast.NodeVisitor):
    ...
    def _inline_func_call(self, func_name: str, call_node: ast.Call):
        ...
        renamed_body = [renamer.visit(stmt) for stmt in renamed_body]
...
class _NameRenamer(ast.NodeTransformer):
    ...
    def __init__(self, rename_map: dict[str, str], result_var: str):
    ...
    def visit_Return(self, node: ast.Return) -> ast.Assign:
        """Convert 'return expr' → '__func_ret_N__ = expr'."""
        # Visit the return value to rename variables inside it
