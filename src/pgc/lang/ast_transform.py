...
class KernelTransformer(ast.NodeVisitor):
    ...
    def _try_parse_shared_alloc(self, target_name: str, value_node: ast.Call):
        """Try to parse smem = pgc.shared(pgc.f32, 256). Returns IRSharedAlloc or None."""
        try:
        ...
        if len(value_node.args) != 2:
            raise NotImplementedError("pgc.shared() takes exactly 2 arguments (dtype, size)")
