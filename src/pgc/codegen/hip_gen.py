"""PGC HIP C code generation — transforms PGC IR to HIP C source for hipRTC.
...
from pgc.codegen.cuda_gen import CUDACodeGen


class HIPCodeGen(CUDACodeGen):
    """Generates HIP C source from a PGC IR function.
