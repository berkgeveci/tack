...
and methods marked with @pgc.func are inlined.

This is PGC's way of writing reusable, parameterized compute objects.
...
grad_out = pgc.field(dtype=pgc.f32, shape=(n,))
...
@pgc.kernel
def compute_gradient(grid: pgc.template(), grad_out):
