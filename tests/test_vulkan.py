"""Tests for the Vulkan compute backend."""
...
def vulkan_backend():
    """Initialize Vulkan backend for all tests in this module."""
    try:
...
def test_large_array():
    """Test with a larger array to exercise multiple workgroups."""
    n = 1_000_000
    x = pgc.field(dtype=pgc.f32, shape=(n,))
    y = pgc.field(dtype=pgc.f32, shape=(n,))
    out = pgc.field(dtype=pgc.f32, shape=(n,))
