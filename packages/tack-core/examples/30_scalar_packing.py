...
per kernel. Tack automatically packs scalar parameters into typed constant
...
# Tack automatically packs all 33 scalars into 2 constant buffers (one f32, one i32).
@tack.kernel
