"""Tack IR optimization passes — LICM and CSE.
...
# This is critical for inlined @tack.func calls that re-load field values
...
# ---------------------------------------------------------------------------
#
# When inlining @tack.func, each call creates a fresh copy of every parameter:
#   __func_b_0__ = b
#   __func_b_1__ = b
...
# ---------------------------------------------------------------------------
#
# When @tack.func calls are inlined, the same field loads (e.g. block_cell_dims[b])
