...
Available: pgc.atomic_add, pgc.atomic_min, pgc.atomic_max
...
total = pgc.field(dtype=pgc.f32, shape=(1,))
...
min_val = pgc.field(dtype=pgc.f32, shape=(1,))
max_val = pgc.field(dtype=pgc.f32, shape=(1,))
...
bins = pgc.field(dtype=pgc.f32, shape=(10,))
bins.fill(0.0)
